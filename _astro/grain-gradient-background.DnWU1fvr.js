import{j as R}from"./jsx-runtime.D_zvdyIk.js";import{r as g}from"./index.DiEladB3.js";const T=`#version 300 es
...
}`;function H(){const t=navigator.userAgent.toLowerCase();return t.includes("safari")&&!t.includes("chrome")&&!t.includes("android")}function z(){const t=visualViewport?.scale??1,e=visualViewport?.width??window.innerWidth,o=window.innerWidth-document.documentElement.clientWidth,i=t*e+o,n=outerWidth/i,s=Math.round(100*n);return s%5===0?s/100:s===33?1/3:s===67?2/3:s===133?4/3:n}const N={fit:"contain",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},Y={none:0,contain:1,cover:2},k=`
...
`,M={maxColorCount:7},Z=`#version 300 es
