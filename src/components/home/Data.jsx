...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className='home__title'>Gabriel Castillo
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle"> Jr Developer</h3>
        <p className="home__description">
        I consider myself a person passionate about technology and programming, willing to learn and adapt quickly to new environments and challenges. I am confident that my focus on continuous learning and my ability to solve problems will allow me to successfully perform the role of programmer in your company.
        </p>
